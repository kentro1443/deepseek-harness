...
export const zh = {
  ...
  'details.output': '输出',
  'details.running': '运行中…',
  'details.reviewTitle': '变更审查',
  'details.branchInfo': '分支 main → origin/main',
  'details.noChanges': '当前会话暂无文件变更',
  'details.changesCount': '共 {count} 个改动文件',
  'details.changes': '变更',
  'todo.title': '任务',
...
export const en = {
  ...
  'details.reviewTitle': 'Review Changes',
  'details.branchInfo': 'Branch main → origin/main',
  'details.noChanges': 'No file changes in current session',
  'details.changesCount': '{count} changed file(s)',
