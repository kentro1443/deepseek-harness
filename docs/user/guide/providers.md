...
This guide assumes you started the Web UI with `npx @deepseek-ai/dsh web` or `pnpm dsh web` ([Web alias](../../../apps/cli/reference/README.md#web-alias)). Model changes take effect on the next request without restarting the server.
