...
To use a fresh source checkout instead, complete the [setup tutorial](../../../development.md#setup-tutorial) and [source execution](../../../../apps/cli/reference/README.md#source-execution), keep this tutorial's `hello-plugin` directory at the repository root, and run the remaining `dsh ...` commands from there as `pnpm dsh ...`.
