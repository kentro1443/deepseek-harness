...
如果改用全新的源码 checkout，请先完成[环境搭建教程](../../../development.md#setup-tutorial)和[源码执行](../../../../apps/cli/reference/README.md#source-execution)，将本教程的 `hello-plugin` 目录放在仓库根目录，并从该目录把下文的 `dsh ...` 命令改为 `pnpm dsh ...`。
